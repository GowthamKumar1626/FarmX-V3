Map<dynamic, dynamic> diseaseDetails = {
  ...
  'Cherry_(including_sour)___Powdery_mildew':
      """ Crop : Cherry \n Disease: Powdery Mildew \n
        ...
        \n How to prevent/cure the disease <br/>
  ...
  'Peach___healthy': """ Crop : Peach \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  'Pepper_bell___healthy': """ Crop : Pepper \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
...
List<DiseaseCause> diseaseCauseList = [
  DiseaseCause(
    diseaseName: 'Apple___Apple_scab',
    diseaseCause: """ Crop : Apple \n Disease: Apple Scab\n
        Cause of disease:
        \n1. Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.
        \n2. Fungal spores are carried by wind, rain or splashing water from the ground to flowers, leaves or fruit. During damp or rainy periods, newly opening apple leaves are extremely susceptible to infection. The longer the leaves remain wet, the more severe the infection will be. Apple scab spreads rapidly between 55-75 degrees Fahrenheit.
        \nHow to prevent/cure the disease 
  ...
  DiseaseCause(
    diseaseName: 'Pepper_bell___healthy',
    diseaseCause: """ Crop : Pepper \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
    diseaseName: 'Potato___healthy',
    diseaseCause: """ Crop : Potato \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
    diseaseName: 'Raspberry___healthy',
    diseaseCause: """ Crop : Raspberry \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
    diseaseName: 'Soybean___healthy',
    diseaseCause: """ Crop : Soyabean \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
    diseaseName: 'Strawberry___healthy',
    diseaseCause: """ Crop : Strawberry \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
    diseaseName: 'Tomato___healthy',
    diseaseCause: """ Crop : Tomato \n Disease: No disease \n
        Don't worry. Your crop is healthy. Keep it up !!!""",
  ),
  DiseaseCause(
  ...
  DiseaseCause(
    diseaseName: 'Tomato___Target_Spo',
    diseaseCause: """ Crop : Tomato \n Disease: Target Spot \n
        Cause of disease:
        \n1. The fungus causes plants to lose their leaves; it is a major disease. If infection occurs before the fruit has developed, yields are low.
        \n2. This is a common disease on tomato in Pacific island countries. The disease occurs in the screen house and in the field.

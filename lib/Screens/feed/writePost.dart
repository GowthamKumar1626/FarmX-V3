...
class _WritePost extends State<WritePost> {
  ...
  Future<void> _getImageAndCrop() async {
    ...
    PickedFile? imageFileFromGallery =
        await picker.getImage(source: ImageSource.gallery);
    if (imageFileFromGallery != null) {
      File imageFileFromGallery2 = File(imageFileFromGallery.path);
      //File cropImageFile = await Utils.cropImageFile(
      //   imageFileFromGallery2); //await cropImageFile(imageFileFromGallery);
      if (imageFileFromGallery2 != null) {
        setState(() {
          _postImageFile = imageFileFromGallery2;
        });
      }
    }
  }

...
import 'package:farmx/Screens/feed/commons/utils.dart';
//import 'package:flutter_auth/Screens/feed/controllers/FBCloudMessaging.dart';
...
class FBCloudStore {
  ...
  static commentToPost(
      param0, param1, postData, String text, MyProfileData myData, param5) {}

  static updatePostCommentCount(DocumentSnapshot postData) {}

  static updateCommentLikeCount(
      DocumentSnapshot data, bool isLikePost, MyProfileData myProfileData) {}
}
